...
export const PAYMENT_METHODS = ['نقدي', 'تحويل', 'آخر'] as const
export const HALAQA_LEVELS   = ['مبتدئ', 'متوسط', 'متقدم'] as const
export const HOMEWORK_TYPES  = ['حفظ', 'مراجعة', 'تجويد', 'قراءة'] as const
