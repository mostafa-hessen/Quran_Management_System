-- ================================================================
-- MIGRATION: إضافة الأعمدة المفقودة لجدول المعلمين
-- ================================================================

-- إضافة أعمدة tajweed_level و notes لجدول teachers
ALTER TABLE public.teachers ADD COLUMN IF NOT EXISTS tajweed_level TEXT DEFAULT 'متوسط';
ALTER TABLE public.teachers ADD COLUMN IF NOT EXISTS notes TEXT;

-- تحديث الـ RPC لضمان التزامن
